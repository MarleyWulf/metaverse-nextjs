...
import { fadeIn, fadeIneIn, staggerContainer } from "../utils/motion";

import { TypingText } from "../components";

const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    <div className="gradient-02 z-10"></div>
    <motion.div
    ...
    >
      ...
      <motion.p
        ...
        className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-color"
      >
